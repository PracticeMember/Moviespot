      ...
      (
        <section className=' flex justify-around flex-wrap py-5'>
          <div className='max-w-sm'>
            <img className='rounded' src={poster ? poster : PosterNotFound} alt={movie.title}></img>
          </div>
          <div className='max-w-2xl text-gray-700  dark:text-gray-200'>
            ...
            {movie.genres ? (<p className='flex flex-wrap gap-2'>
              {
                movie.genres.map(genre => (
                  <span key={genre.id} className='bg-slate-100 mr-2 border border-gray-200 rounded-lg dark:border-gray-600 p-2 text-gray-600 dark:text-gray-200 dark:bg-gray-600'>{genre.name}</span>
                ))
              }
            </p>)
              : ("")}
            ...
            <div className="flex items-center my-5">
              ...
              <p className="text-gray-900  dark:text-white">{movie.vote_count} reviews</p>
            </div>
