...
export const Loading = () => {
    return (
        <div role="status" class="space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center my-10">
            <div class="flex items-center justify-center w-full h-96 bg-gray-300 rounded sm:w-96 dark:bg-gray-400">
